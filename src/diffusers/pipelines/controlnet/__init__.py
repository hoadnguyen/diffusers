...
try:
    ...
    _import_structure["pipeline_controlnet_inpaint_v2"] = ["StableDiffusionControlNetInpaintPipelineV2"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_controlnet_inpaint_v2 import StableDiffusionControlNetInpaintPipelineV2
